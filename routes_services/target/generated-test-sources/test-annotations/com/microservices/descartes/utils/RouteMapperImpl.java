...
public class RouteMapperImpl extends RouteMapper {
    ...
    @Override
    public Route toRouteFromRoutePDTO(RoutePutDTO routePutDTO) {
        if ( routePutDTO == null ) {
            return null;
        }
        ...
        route.id( routePutDTO.getId() );
        route.date( routePutDTO.getDate() );
        route.status( routePutDTO.getStatus() );
        route.stops( stopsPutDTOListToStopsList( routePutDTO.getStops() ) );
